...
Vue.component("letter-button", {
    ...
    watch: {
        ...
        // re-enable all buttons when a new two-payer game is started
...
let app = new Vue({
    ...
    data: {
        ...
        // currentWord will be set to a random word from the above list
        currentWord: "",
        // each element is this array is a letter in a word
        wordDivs: [],
        ...
        canvas: "",
        // will be set to the vanvas 2d context
        ctx: ""
    },
    methods: {
        // draws the gallows
        ...
        updateCanvas: function (ctx) {
            ...
            // draw the left arm and handle game over
                ...
                // game over
                ctx.font = "34px Courier New, Courier, monospace";
        ...
        check: function (letter) {
            if (!this.gameOver) {
                ...
                // if there are no more blanks in the work, you win
                if (!this.wordDivs.some(function(value) { return value == "" })) {
                    this.gameOver = true;
                    this.ctx.font = "34px Courier New, Courier, monospace";
        ...
        // start two-player mode and prompts the user to enter a word
        twoPlayer: function () {
            if (!this.twoPlayers) {
                this.gameOver = true;
    ...
    //identify the canvas element and initialize it, draw th egallows, choose a word, and draw the blanks
    mounted: function () {
