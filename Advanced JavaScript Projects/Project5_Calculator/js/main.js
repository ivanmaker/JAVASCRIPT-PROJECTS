...
const Calculator = {
    ...
    Display_Value: "0",
    //This will hold the first operand for any expression, we it to null for now
    First_Operand: null,
    //This check weather or not the second operand has been input by the user
...
//This function updates the calculator screen with teh contens of the Display_Value
...
Update_Display();
//This section monitors button clickes
const keys = document.querySelector(".calculator-keys");
keys.addEventListener("click", (event) => {
    //The target variable is an object that respresents the element
    //that was clicked
    const {target} = event;
